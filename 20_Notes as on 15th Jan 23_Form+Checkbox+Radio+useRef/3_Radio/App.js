...
const App=()=>{ 
    const[data,setData]=useState({name:"",age:"",email:"",address:"",country:"",sure:false,gender:"male"});     
    ...
    return(
        <>
            ...
            Gender : <input type="radio" checked={data.gender==="male"} value="male"  name="gender" onChange={handleChange} />Male
            <input type="radio" value="female"  checked={data.gender==="female"}  name="gender" onChange={handleChange} />Female
